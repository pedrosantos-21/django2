...
SECRET_KEY = 'django-insecure-a9clr9&he!g&1(aq%^o-6jvzt7$3%7l(*e*oepuk&6^zqjecfc'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False # Set to False in production

ALLOWED_HOSTS = ['pedrosantos21.pythonanywhere.com']
...
DATABASES = {
    'default': {
        ...
        'HOST': os.environ.get('DATABASE_HOST', ''), # 'db' quando rodando com docker-compose
        'PORT': os.environ.get('DATABASE_PORT', ''), # '3306' quando rodando com docker-compose
